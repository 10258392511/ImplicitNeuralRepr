# Adapted from https://github.com/yinboc/liif/blob/main/models/rdn.py
import torch
...
class RDN(nn.Module):
    def __init__(self, in_channels, out_channels, num_rdb_blocks, num_conv_layers):
        super(RDN, self).__init__()
        args = Namespace()
        args.G0 = out_channels  ###
        args.RDNkSize = 3
        ...
        #     'B': (16, 8, 64),
        # }[args.RDNconfig]
        self.D, C, G = num_rdb_blocks, num_conv_layers, out_channels
